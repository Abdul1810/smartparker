    ...
    <div class="min-h-screen flex flex-row items-center">
        ...
        <div class="bg-white w-1/2">
            <div class="flex px-12 items-center justify-between">
                ...
                <a href="register.php"
                    class="btn btn-primary-outline px-4 py-2 rounded-md text-blue-600 font-semibold border border-blue-600 hover:text-white hover:bg-blue-600 focus:text-white focus:bg-blue-600">Register</a>
            </div>
            ...
            <form action="auth/login.php" method="POST" id="login-form" class="p-12">
                <div class="mb-4">
                    ...
                    <input type="text" id="vehicle-registration" name="vehicle-registration"
                        class="w-full px-4 py-2 border border-1 border-black border-opacity-20 rounded focus:outline-none focus:border-blue-500"
                        required autofocus placeholder="TN-01-AB-1234" maxlength="13" minlength="13" oninput="addHyphens(this)">
                </div>
                <div class="flex items-center justify-between">
                    <button type="submit"
                        class="rounded-md text-white font-semibold bg-blue-600 text-white py-2 px-4 rounded hover:bg-blue-700 focus:text-white focus:bg-blue-700">Login</button>
                </div>
            </form>
        </div>
    </div>
