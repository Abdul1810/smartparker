...
<body class="h-screen flex flex-col justify-center items-center">
    <div class="bg-white bg-opacity-80 p-12 rounded-lg shadow-lg text-center">
        <h1 class="text-3xl font-semibold text-blue-500 mb-4">Welcome, <span class="text-green-500">User Name</span>!</h1>
        <p class="text-gray-700">Successfully parked on the Lot: 1</p>
